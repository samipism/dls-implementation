...
# new_order = ['match_id','season','start_date','innings','over','ball','total_balls','balls_remaining','runs_from_ball','total_runs','team_score','runs_remaining','wickets_down','batting_team','bowling_team']
# df = df[new_order]
...
# new_order = ['match_id','season','start_date','innings','over','ball','total_balls','balls_remaining','runs_from_ball','total_runs','team_score','runs_remaining','wickets_down','bat_first','bat_second','winner']
